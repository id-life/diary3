...
export const initDayEntryInstancesAtom = atom(null, (get, set, payload: { dateStr: string }) => {
...
export const createEntryInstanceAtom = atom(null, (get, set, entryInstance: EntryInstance) => {
...
export const deleteEntryInstanceAtom = atom(null, (get, set, entryInstance: EntryInstance) => {
  const dateStr = getDateStringFromTimestamp(entryInstance.createdAt);
  const current = get(entryInstancesMapAtom);
...
export const deleteEntryInstanceByEntryTypeIdAtom = atom(null, (get, set, deleteEntryTypeId: string) => {
  try {
...
export const emptyEntryInstanceAtom = atom(null, (get, set) => {
  set(entryInstancesMapAtom, {});
});
